...
<code> /tr ml </code>"""
    ...
    MRX = """
<b><spoiler>✨New Ai Module:</spoiler></b> 
    
<b><blockquote>Command Usages:</blockquote></b>

<code> /mrx Query </code>
<code> /mmw Query </code>

<b>Note: Once you get the Ai Response, the data are not stored.</b>
"""
...
<b>NOTE:</b>
These are the AI Features of JERRY 
...
"""
    RESTART_TXT = """
<b>Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ !
<blockquote>『👑』 Jᴇʀʀʏ 𝟸.𝟶 ◢ ◤ </blockquote>
📅 Dᴀᴛᴇ : <code>{}</code>
⏰Tɪᴍᴇ : <code>{}</code>
